...
(function(){
  ...
  const T = {
    ...
    en: {
      ...
      ink_d:"Like Word, free and in your language: formatting, tables, images, freehand drawing, and saving as Word or PDF. Your documents stay on your device.",
      ...
      ku2:"New document: File → New Document, and you can pick a template.",
      ku3:"Everything saves automatically. To send it to someone: File → Save as Word or Save as PDF.",
    ...
    ar: {
      ...
      ink_d:"مثل Word، مجاني وبلغتك: تنسيق وجداول وصور ورسم حر وحفظ كملف Word أو PDF. مستنداتك تبقى على جهازك.",
      ...
      ku2:"مستند جديد: ملف ← مستند جديد، ويمكنك اختيار قالب.",
      ku3:"كل شيء يُحفظ تلقائياً. لإرساله: ملف ← حفظ بصيغة Word أو حفظ بصيغة PDF.",
    ...
    zh: {
      ...
      ink_d:"像 Word 一样，免费且支持你的语言：排版、表格、图片、手绘，并可保存为 Word 或 PDF。文档只保存在你的设备上。",
      ...
      ku2:"新建文档：文件 → 新建文档，还可以选择模板。",
      ku3:"一切都会自动保存。要发给别人：文件 → 另存为 Word 或另存为 PDF。",
    ...
    es: {
      ...
      ink_d:"Como Word, gratis y en tu idioma: formato, tablas, imágenes, dibujo a mano y guardar como Word o PDF. Tus documentos se quedan en tu dispositivo.",
      ...
      ku2:"Documento nuevo: Archivo → Documento nuevo, y puedes elegir una plantilla.",
      ku3:"Todo se guarda solo. Para enviarlo: Archivo → Guardar como Word o Guardar como PDF.",
    ...
    fr: {
      ...
      ink_d:"Comme Word, gratuit et dans ta langue : mise en forme, tableaux, images, dessin à main levée et enregistrement en Word ou PDF. Tes documents restent sur ton appareil.",
      ...
      ku2:"Nouveau document : Fichier → Nouveau document, et tu peux choisir un modèle.",
      ku3:"Tout s’enregistre tout seul. Pour l’envoyer : Fichier → Enregistrer au format Word ou Enregistrer en PDF.",
    ...
    pt: {
      ...
      ink_d:"Como o Word, grátis e no seu idioma: formatação, tabelas, imagens, desenho à mão e salvar como Word ou PDF. Seus documentos ficam no seu aparelho.",
      ...
      ku2:"Documento novo: Arquivo → Novo documento, e você pode escolher um modelo.",
      ku3:"Tudo é salvo sozinho. Para enviar: Arquivo → Salvar como Word ou Salvar como PDF.",
    ...
    ru: {
      ...
      ink_d:"Как Word, бесплатно и на твоём языке: оформление, таблицы, картинки, рисование от руки и сохранение в Word или PDF. Документы остаются на твоём устройстве.",
      ...
      ku2:"Новый документ: Файл → Новый документ, можно выбрать шаблон.",
      ku3:"Всё сохраняется само. Чтобы отправить: Файл → Сохранить как Word или Сохранить как PDF.",
    ...
    de: {
      ...
      ink_d:"Wie Word, kostenlos und in deiner Sprache: Formatierung, Tabellen, Bilder, Freihandzeichnen und Speichern als Word oder PDF. Deine Dokumente bleiben auf deinem Gerät.",
      ...
      ku2:"Neues Dokument: Datei → Neues Dokument, und du kannst eine Vorlage wählen.",
      ku3:"Alles wird automatisch gespeichert. Zum Verschicken: Datei → Als Word speichern oder Als PDF speichern.",
