...
(function(){
  ...
  const T = {
    he: {
      ...
      ink_t:"Floating Ink — מסמכים ומצגות",
      ink_d:"כמו Word ו-PowerPoint, בעברית ובחינם: מסמכים ומצגות עם תמונות, טבלאות וציור ביד, ושמירה כ-Word, כפאוורפוינט וכ-PDF. הכל נשמר רק אצלך.",
      ...
      ku2:"משהו חדש: לוחצים על \"חדש\" ובוחרים מסמך או מצגת, ואפשר להתחיל מתבנית (עבודה לבית הספר, סיפור, מכתב…).",
      ku3:"הכל נשמר לבד. כדי לשלוח למורה או לחבר: קובץ ← שמירה כ-Word, כפאוורפוינט או כ-PDF.",
      ku4:"הקלדת באנגלית בטעות? מסמנים ולוחצים Ctrl+Shift+X, והמילים חוזרות לעברית.",
      ku5:"כדי להציג מצגת: לשונית \"הצגה\" ← \"מההתחלה\", והחצים מעבירים בין השקופיות.",
      inknote:"המסמכים נשמרים בדפדפן שבו כתבת אותם. כדי שלא יאבדו אם מוחקים את נתוני הגלישה, כדאי להפעיל גיבוי אוטומטי: קובץ ← גיבוי.",
    ...
    en: {
      ...
      ink_t:"Floating Ink — Documents & Presentations",
      ink_d:"Like Word and PowerPoint, free and in your language: documents and presentations with images, tables and freehand drawing, saved as Word, PowerPoint or PDF. Everything stays on your device.",
      k1:"Click \"Open & install\" — the app opens in a new tab.",
      k2:"On a computer (Chrome or Edge): click the “Install” button at the top of the app, or the install icon at the end of the address bar.",
      ...
      ku2:"Something new: click “New” and choose a document or a presentation — you can start from a template.",
      ku3:"Everything saves automatically. To send it to someone: File → Save as Word, PowerPoint or PDF.",
      ku4:"To change the app’s language, click the 🌐 button at the top. You can write in any language.",
      ku5:"To present: the Slide Show tab → From Beginning, and the arrow keys move between slides.",
      inknote:"Documents are saved in the browser you wrote them in. So they aren't lost if you clear your browsing data, turn on automatic backup: File → Backup.",
    ...
    ar: {
      ...
      ink_t:"Floating Ink — مستندات وعروض تقديمية",
      ink_d:"مثل Word وPowerPoint، مجاني وبلغتك: مستندات وعروض تقديمية مع صور وجداول ورسم حر، وحفظ بصيغة Word أو PowerPoint أو PDF. كل شيء يبقى على جهازك.",
      k1:"اضغط على \"فتح وتثبيت\" — سيفتح التطبيق في علامة تبويب جديدة.",
      k2:"على الكمبيوتر (Chrome أو Edge): اضغط زر «تثبيت» أعلى التطبيق، أو أيقونة التثبيت في نهاية شريط العنوان.",
      ...
      ku2:"شيء جديد: اضغط «جديد» واختر مستندًا أو عرضًا تقديميًا، ويمكنك البدء من قالب.",
      ku3:"كل شيء يُحفظ تلقائياً. لإرساله: ملف ← حفظ بصيغة Word أو PowerPoint أو PDF.",
      ku4:"لتغيير لغة التطبيق، اضغط زر 🌐 في الأعلى. يمكنك الكتابة بأي لغة.",
      ku5:"للعرض: تبويب «عرض الشرائح» ← «من البداية»، والأسهم تنقلك بين الشرائح.",
      inknote:"تُحفظ المستندات في المتصفح الذي كتبتها فيه. حتى لا تضيع إذا مسحت بيانات التصفح، فعّل النسخ الاحتياطي التلقائي: ملف ← النسخ الاحتياطي.",
    ...
    zh: {
      ...
      ink_t:"Floating Ink — 文档和演示文稿",
      ink_d:"像 Word 和 PowerPoint 一样，免费且支持你的语言：带图片、表格和手绘的文档和演示文稿，可保存为 Word、PowerPoint 或 PDF。一切都只保存在你的设备上。",
      k1:"点击\"打开并安装\"——应用会在新标签页中打开。",
      k2:"在电脑上（Chrome 或 Edge）：点击应用顶部的“安装”按钮，或地址栏末尾的安装图标。",
      k3:"在安卓上:菜单 ⋮ → \"安装应用\"或\"添加到主屏幕\"。",
      k4:"在 iPhone 上:用 Safari 打开,点击分享 → \"添加到主屏幕\"。",
      ku1:"安装后,Floating Ink 像普通软件一样打开,离线也能用。",
      ku2:"新建：点击“新建”，选择文档或演示文稿，还可以从模板开始。",
      ku3:"一切都会自动保存。要发给别人：文件 → 另存为 Word、PowerPoint 或 PDF。",
      ku4:"点击顶部的 🌐 按钮可以更换应用的语言。你可以用任何语言写作。",
      ku5:"放映：“放映”选项卡 → “从头开始”，用方向键切换幻灯片。",
      inknote:"文档保存在你书写时使用的浏览器中。为了在清除浏览数据后也不丢失，建议开启自动备份：文件 → 备份。",
    ...
    es: {
      ...
      ink_t:"Floating Ink — Documentos y presentaciones",
      ink_d:"Como Word y PowerPoint, gratis y en tu idioma: documentos y presentaciones con imágenes, tablas y dibujo a mano, y guardar como Word, PowerPoint o PDF. Todo se queda en tu dispositivo.",
      k1:"Pulsa \"Abrir e instalar\": la app se abre en una pestaña nueva.",
      k2:"En el ordenador (Chrome o Edge): pulsa el botón “Instalar” arriba en la app, o el icono de instalación al final de la barra de direcciones.",
      ...
      ku2:"Algo nuevo: pulsa “Nuevo” y elige un documento o una presentación; puedes empezar con una plantilla.",
      ku3:"Todo se guarda solo. Para enviarlo: Archivo → Guardar como Word, PowerPoint o PDF.",
      ku4:"Para cambiar el idioma de la app, pulsa el botón 🌐 de arriba. Puedes escribir en cualquier idioma.",
      ku5:"Para presentar: pestaña Presentar → Desde el principio, y las flechas pasan las diapositivas.",
      inknote:"Los documentos se guardan en el navegador donde los escribiste. Para no perderlos si borras los datos de navegación, activa la copia automática (Archivo → Copia de seguridad).",
    ...
    fr: {
      ...
      ink_t:"Floating Ink — Documents et présentations",
      ink_d:"Comme Word et PowerPoint, gratuit et dans ta langue : documents et présentations avec images, tableaux et dessin à main levée, enregistrés en Word, PowerPoint ou PDF. Tout reste sur ton appareil.",
      k1:"Clique sur « Ouvrir et installer » : l’appli s’ouvre dans un nouvel onglet.",
      k2:"Sur ordinateur (Chrome ou Edge) : clique sur le bouton « Installer » en haut de l’appli, ou sur l’icône d’installation au bout de la barre d’adresse.",
      ...
      ku2:"Quelque chose de nouveau : clique sur « Nouveau » et choisis un document ou une présentation ; tu peux partir d’un modèle.",
      ku3:"Tout s’enregistre tout seul. Pour l’envoyer : Fichier → Enregistrer au format Word, PowerPoint ou PDF.",
      ku4:"Pour changer la langue de l’appli, clique sur le bouton 🌐 en haut. Tu peux écrire dans n’importe quelle langue.",
      ku5:"Pour présenter : onglet Diaporama → Depuis le début, et les flèches font défiler les diapositives.",
      inknote:"Les documents sont enregistrés dans le navigateur où tu les as écrits. Pour ne pas les perdre si tu effaces les données de navigation, active la sauvegarde automatique (Fichier → Sauvegarde).",
    ...
    pt: {
      ...
      app:"APP", openApp:"↗ Abrir e instalar",
      ink_t:"Floating Ink — Documentos e apresentações",
      ink_d:"Como o Word e o PowerPoint, grátis e no seu idioma: documentos e apresentações com imagens, tabelas e desenho à mão, e salvar como Word, PowerPoint ou PDF. Tudo fica no seu aparelho.",
      k1:"Clique em \"Abrir e instalar\": o app abre em uma nova aba.",
      k2:"No computador (Chrome ou Edge): clique no botão “Instalar” no topo do app, ou no ícone de instalação no fim da barra de endereço.",
      ...
      ku2:"Algo novo: clique em “Novo” e escolha um documento ou uma apresentação; dá para começar de um modelo.",
      ku3:"Tudo é salvo sozinho. Para enviar: Arquivo → Salvar como Word, PowerPoint ou PDF.",
      ku4:"Para mudar o idioma do app, clique no botão 🌐 no topo. Você pode escrever em qualquer idioma.",
      ku5:"Para apresentar: aba Apresentar → Do início, e as setas passam os slides.",
      inknote:"Os documentos ficam salvos no navegador em que você os escreveu. Para não perdê-los se limpar os dados de navegação, ative o backup automático (Arquivo → Backup).",
    ...
    ru: {
      ...
      ink_t:"Floating Ink — документы и презентации",
      ink_d:"Как Word и PowerPoint, бесплатно и на твоём языке: документы и презентации с картинками, таблицами и рисованием от руки, сохранение в Word, PowerPoint или PDF. Всё остаётся на твоём устройстве.",
      k1:"Нажми «Открыть и установить» — приложение откроется в новой вкладке.",
      k2:"На компьютере (Chrome или Edge): нажми кнопку «Установить» вверху приложения или значок установки в конце адресной строки.",
      ...
      ku2:"Что-то новое: нажми «Создать» и выбери документ или презентацию — можно начать с шаблона.",
      ku3:"Всё сохраняется само. Чтобы отправить: Файл → Сохранить как Word, PowerPoint или PDF.",
      ku4:"Чтобы сменить язык приложения, нажми кнопку 🌐 вверху. Писать можно на любом языке.",
      ku5:"Чтобы показать презентацию: вкладка «Показ» → «С начала», а стрелки листают слайды.",
      inknote:"Документы хранятся в том браузере, где они созданы. Чтобы они не пропали при очистке данных браузера, включи автоматическое копирование (Файл → Резервная копия).",
    ...
    de: {
      ...
      ink_t:"Floating Ink — Dokumente und Präsentationen",
      ink_d:"Wie Word und PowerPoint, kostenlos und in deiner Sprache: Dokumente und Präsentationen mit Bildern, Tabellen und Freihandzeichnen, gespeichert als Word, PowerPoint oder PDF. Alles bleibt auf deinem Gerät.",
      k1:"Klicke auf „Öffnen & installieren“ – die App öffnet sich in einem neuen Tab.",
      k2:"Am Computer (Chrome oder Edge): Klicke oben in der App auf „Installieren“ oder auf das Installationssymbol am Ende der Adressleiste.",
      ...
      ku2:"Etwas Neues: Klicke auf „Neu“ und wähle ein Dokument oder eine Präsentation – du kannst mit einer Vorlage beginnen.",
      ku3:"Alles wird automatisch gespeichert. Zum Verschicken: Datei → Als Word, PowerPoint oder PDF speichern.",
      ku4:"Die Sprache der App änderst du mit dem 🌐-Button oben. Schreiben kannst du in jeder Sprache.",
      ku5:"Zum Präsentieren: Tab „Präsentieren“ → „Von Beginn an“, und die Pfeiltasten blättern durch die Folien.",
      inknote:"Die Dokumente werden in dem Browser gespeichert, in dem du sie geschrieben hast. Damit sie nicht verloren gehen, wenn du die Browserdaten löschst, schalte die automatische Sicherung ein (Datei → Sicherung).",
