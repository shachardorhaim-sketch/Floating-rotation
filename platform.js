...
const GAMES = [
  ...
  { id:'pong', title:'פינג פונג', desc:'מול המחשב, מול חבר על אותו מחשב, או אונליין עם קוד חדר.', icon:'🏓', badge:'ספורט', bg:'linear-gradient(135deg,#123a2a,#0d1b2a)', mount:mountIframe('https://shachardorhaim-sketch.github.io/ping-pong-3d/') },
];
...
(function(){
  ...
  const GTITLE = {dino:'t_dino', catch:'t_catch', memory:'t_memory', chess:'t_chess', tetris:'t_tetris', button:'button_t', soon:'fight_t', pong:'t_pong'};
  const GDESC = {dino:'dino', catch:'catch', memory:'memory', button:'button', chess:'chess', tetris:'tetris', soon:'fight', pong:'pong'};
  const LSK = 'flrot:';
