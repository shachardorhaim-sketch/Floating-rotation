...
const GAMES = [
  ...
  { id:'pong', title:'Ping Pong 3D', desc:'פינג פונג תלת-ממדי מול המחשב — שלוש רמות קושי.', icon:'🏓', badge:'תלת-ממד', bg:'linear-gradient(135deg,#123a2a,#0d1b2a)', mount:mountIframe('https://shachardorhaim-sketch.github.io/ping-pong-3d/') },
];
...
(function(){
  ...
  const RTL = ['he','ar'];
  const BADGE = {'ARCADE':'arcade','CASUAL':'casual','PUZZLE':'puzzle','STRATEGY':'strategy','חדש!':'newb','SOON':'soonb','רובין':'robin','תלת-ממד':'threeD'};
